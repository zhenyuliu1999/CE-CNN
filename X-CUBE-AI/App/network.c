...
#define AI_NETWORK_MODEL_SIGNATURE     "267ca0db344522f5c97daaedff8e0324"
...
#define AI_TOOLS_DATE_TIME   "Sun Jun 16 19:52:05 2024"
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_OUT_NUM, &dense_5_dense_output),
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    input_1_output_array.data = AI_PTR(g_network_activations_map[0] + 100);
    input_1_output_array.data_start = AI_PTR(g_network_activations_map[0] + 100);
    
    conv1d_conv2d_output_array.data = AI_PTR(g_network_activations_map[0] + 0);
    conv1d_conv2d_output_array.data_start = AI_PTR(g_network_activations_map[0] + 0);
    
    conv1d_output_array.data = AI_PTR(g_network_activations_map[0] + 0);
    conv1d_output_array.data_start = AI_PTR(g_network_activations_map[0] + 0);
    
    batch_normalization_output_array.data = AI_PTR(g_network_activations_map[0] + 0);
    batch_normalization_output_array.data_start = AI_PTR(g_network_activations_map[0] + 0);
    
    max_pooling1d_output_array.data = AI_PTR(g_network_activations_map[0] + 0);
    max_pooling1d_output_array.data_start = AI_PTR(g_network_activations_map[0] + 0);
    
    global_average_pooling1d_output_array.data = AI_PTR(g_network_activations_map[0] + 5760);
    global_average_pooling1d_output_array.data_start = AI_PTR(g_network_activations_map[0] + 5760);
    
    dense_2_dense_output_array.data = AI_PTR(g_network_activations_map[0] + 5824);
    dense_2_dense_output_array.data_start = AI_PTR(g_network_activations_map[0] + 5824);
    
    dense_2_output_array.data = AI_PTR(g_network_activations_map[0] + 5888);
    dense_2_output_array.data_start = AI_PTR(g_network_activations_map[0] + 5888);
    
    dense_3_dense_output_array.data = AI_PTR(g_network_activations_map[0] + 5824);
    dense_3_dense_output_array.data_start = AI_PTR(g_network_activations_map[0] + 5824);
    
    dense_3_output_array.data = AI_PTR(g_network_activations_map[0] + 5888);
    dense_3_output_array.data_start = AI_PTR(g_network_activations_map[0] + 5888);
    
    dense_dense_output_array.data = AI_PTR(g_network_activations_map[0] + 5824);
    dense_dense_output_array.data_start = AI_PTR(g_network_activations_map[0] + 5824);
    
    dense_output_array.data = AI_PTR(g_network_activations_map[0] + 5760);
    dense_output_array.data_start = AI_PTR(g_network_activations_map[0] + 5760);
    
    dense_1_dense_output_array.data = AI_PTR(g_network_activations_map[0] + 5792);
    dense_1_dense_output_array.data_start = AI_PTR(g_network_activations_map[0] + 5792);
    
    dense_1_output_array.data = AI_PTR(g_network_activations_map[0] + 5952);
    dense_1_output_array.data_start = AI_PTR(g_network_activations_map[0] + 5952);
    
    multiply_output_array.data = AI_PTR(g_network_activations_map[0] + 0);
    multiply_output_array.data_start = AI_PTR(g_network_activations_map[0] + 0);
    
    add_output_array.data = AI_PTR(g_network_activations_map[0] + 0);
    add_output_array.data_start = AI_PTR(g_network_activations_map[0] + 0);
    
    dense_4_dense_output_array.data = AI_PTR(g_network_activations_map[0] + 5760);
    dense_4_dense_output_array.data_start = AI_PTR(g_network_activations_map[0] + 5760);
    ...
    dense_5_dense_output_array.data = AI_PTR(g_network_activations_map[0] + 256);
    dense_5_dense_output_array.data_start = AI_PTR(g_network_activations_map[0] + 256);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    conv1d_conv2d_bias_array.data = AI_PTR(g_network_weights_map[0] + 1792);
    conv1d_conv2d_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 1792);
    
    batch_normalization_scale_array.format |= AI_FMT_FLAG_CONST;
    batch_normalization_scale_array.data = AI_PTR(g_network_weights_map[0] + 1856);
    batch_normalization_scale_array.data_start = AI_PTR(g_network_weights_map[0] + 1856);
    
    batch_normalization_bias_array.format |= AI_FMT_FLAG_CONST;
    batch_normalization_bias_array.data = AI_PTR(g_network_weights_map[0] + 1920);
    batch_normalization_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 1920);
    
    dense_2_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_2_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 1984);
    dense_2_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 1984);
    
    dense_2_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_2_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 3008);
    dense_2_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 3008);
    
    dense_3_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_3_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 3072);
    dense_3_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 3072);
    
    dense_3_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_3_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 4096);
    dense_3_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 4096);
    
    dense_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 4160);
    dense_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 4160);
    
    dense_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 4672);
    dense_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 4672);
    
    dense_1_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_1_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 4704);
    dense_1_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 4704);
    
    dense_1_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_1_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 5216);
    dense_1_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 5216);
    
    dense_4_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_4_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 6304);
    dense_4_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 5280);
    
    dense_4_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_4_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 98464);
    dense_4_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 98464);
    
    dense_5_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_5_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 98720);
    dense_5_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 98720);
    
    dense_5_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_5_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 98976);
    dense_5_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 98976);
