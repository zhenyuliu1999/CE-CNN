...
/******************************************************************************/
#define AI_CECNN_MODEL_NAME          "cecnn"
#define AI_CECNN_ORIGIN_MODEL_NAME   "ecnn4003607"

/******************************************************************************/
#define AI_CECNN_ACTIVATIONS_ALIGNMENT   (4)
#define AI_CECNN_INPUTS_IN_ACTIVATIONS   (4)
#define AI_CECNN_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_CECNN_IN_NUM        (1)

AI_DEPRECATED
#define AI_CECNN_IN \
  ai_cecnn_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_CECNN_IN_SIZE { \
  AI_CECNN_IN_1_SIZE, \
}
#define AI_CECNN_IN_SIZE_BYTES { \
  AI_CECNN_IN_1_SIZE_BYTES, \
}
#define AI_CECNN_IN_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_CECNN_IN_1_HEIGHT      (360)
#define AI_CECNN_IN_1_CHANNEL     (7)
#define AI_CECNN_IN_1_SIZE        (360 * 7)
#define AI_CECNN_IN_1_SIZE_BYTES  (10080)

/******************************************************************************/
#define AI_CECNN_OUT_NUM       (1)

AI_DEPRECATED
#define AI_CECNN_OUT \
  ai_cecnn_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_CECNN_OUT_SIZE { \
  AI_CECNN_OUT_1_SIZE, \
}
#define AI_CECNN_OUT_SIZE_BYTES { \
  AI_CECNN_OUT_1_SIZE_BYTES, \
}
#define AI_CECNN_OUT_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_CECNN_OUT_1_CHANNEL     (1)
#define AI_CECNN_OUT_1_SIZE        (1)
#define AI_CECNN_OUT_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_CECNN_N_NODES (18)
 ...
 * @ref ai_cecnn_create. Both the activations memory buffer 
 ...
 */
AI_API_ENTRY
ai_buffer* ai_cecnn_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_CECNN_*
 * defines into file @ref cecnn.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
