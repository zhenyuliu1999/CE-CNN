...
AI_ALIGNED(32)
static uint8_t pool0[AI_CECNN_DATA_ACTIVATION_1_SIZE];
...
static const ai_network_entry_t networks[AI_MNETWORK_NUMBER] = {
    {
        .name = (const char *)AI_CECNN_MODEL_NAME,
        .config = AI_CECNN_DATA_CONFIG,
        .ai_get_report = ai_cecnn_get_report,
        .ai_create = ai_cecnn_create,
        .ai_destroy = ai_cecnn_destroy,
        .ai_get_error = ai_cecnn_get_error,
        .ai_init = ai_cecnn_init,
        .ai_run = ai_cecnn_run,
        .ai_forward = ai_cecnn_forward,
        .ai_data_params_get = ai_cecnn_data_params_get,
